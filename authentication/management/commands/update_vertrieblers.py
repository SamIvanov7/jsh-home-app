...
from config.settings import ENV_FILE, ZOHO_ACCESS_TOKEN, BASE_URL_PRIV_KUNDEN, ZOHO_CLIENT_ID, ZOHO_CLIENT_SECRET, ZOHO_REFRESH_TOKEN, DEFAULT_EMAIL_DOMAIN, DEFAULT_PHONE, DEFAULT_USER_CREATION_PASSWORD
    ...
    def handle(self, *args, **kwargs):
        ...
        for user_info in zoho_users_list:
            ...
            if isinstance(user_info, list) and len(user_info) >= 2:
                ...
                email = first_name[0].lower() + last_name[0].lower() + f"{DEFAULT_EMAIL_DOMAIN}"
