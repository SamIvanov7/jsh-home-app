...
class PDF(FPDF):
    ...
    def page2(self, data, user_folder):
        self.add_page()
        self.set_fill_color(240)
        ...
        try:
            ...
            ax.figure.savefig(f"{user_folder}/tmp.png")
            self.image(f"{user_folder}/tmp.png", x=10, y=185, w=200)
            os.remove(f"{user_folder}/tmp.png")
